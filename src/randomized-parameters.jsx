...
export const predictionItems = shuffle([
    trialType1, trialType1, trialType1, 
    trialType2, trialType2, trialType2,  
    trialType3, trialType3, trialType3, 
    trialType4, trialType4, trialType4,  
    trialType5, trialType5, trialType5, 
    trialType6, trialType6, trialType6,  
    trialType7, trialType7, trialType7, 
    trialType8, trialType8, trialType8, 
    trialType9, trialType9, trialType9
])


// put the test items together and export them
export const testItems = [[trialType7, trialType7], shuffle(
    [[trialType6, trialType6],
    [trialType8, trialType8],
    [trialType9, trialType9]]
).flat()].flat();
...
export const display_order_within = [
    [0,1].concat(shuffle([2,3])),
    [0,1].concat(shuffle([2,3]))
];
...
// the machines we show during the test phase
...
const mainColors = [shuffle(['black', 'red']), shuffle(['blue', 'green'])];
